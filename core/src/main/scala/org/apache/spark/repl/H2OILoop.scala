...
import org.reflections.scanners.{SubTypesScanner, Scanner}
import org.reflections.serializers.Serializer
import org.reflections.util.{FilterBuilder, ConfigurationBuilder}
import org.reflections.{ReflectionUtils, Configuration, Reflections}
  ...
  private def process(settings: Settings): Boolean = savingContextLoader {
    ...
    def createSparkContext(): SparkContext = {
      ...
      val conf = new SparkConf()
        ...
        .setJars(jars)
        .set("spark.repl.class.uri", InterpreterUtils.classServerUri)
      if (execUri != null) {
